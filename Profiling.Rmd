...
Pi function adapted from: https://www.r-bloggers.com/2012/10/estimation-of-the-number-pi-a-monte-carlo-simulation/
</div>
...
* **rbenchmark**, **microbenchmark** functions will give statistics over independent replicas of the
  code


* More useful information from profiling functions will be obtained if one uses functions to
  enclose independent tasks in your code (remember *pow2*, *runif* in the Pi calculation)

* Once you know what are the bottlenecks of your code, working on a few of the most expensive ones could
  be more effective than working on many less significative functions
